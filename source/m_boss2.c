...
void boss2_firebullet_right(edict_t *self)
{
    ...
    monster_fire_bullet(self, start, NULL, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_BOSS2_MACHINEGUN_R1);
}
...
void boss2_firebullet_left(edict_t *self)
{
    ...
    monster_fire_bullet(self, start, NULL, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_BOSS2_MACHINEGUN_L1);
}
