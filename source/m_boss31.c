...
void jorgBFG(edict_t *self)
{
    ...
    monster_fire_bfg(self, start, NULL, 50, 300, 100, 200, MZ2_JORG_BFG_1);
}
...
void jorg_firebullet_right(edict_t *self)
{
    ...
    monster_fire_bullet(self, start, NULL, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_R1);
}
...
void jorg_firebullet_left(edict_t *self)
{
    ...
    monster_fire_bullet(self, start, NULL, 6, 4, DEFAULT_BULLET_HSPREAD, DEFAULT_BULLET_VSPREAD, MZ2_JORG_MACHINEGUN_L1);
}
